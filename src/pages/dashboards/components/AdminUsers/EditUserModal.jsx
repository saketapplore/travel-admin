...
const EditUserModal = ({
  ...
  useEffect(() => {
    if (user) {
      ...
      setForm({
        ...
        confirmPassword: '',
        modules: {
          ...AVAILABLE_MODULES.reduce((acc, m) => ({ ...acc, [m.id]: m.id === 'dashboard' }), {}),
          ...(user.modules || {})
        }
      });
    }
  ...
  return (
    ...
    >
      ...
      >
        <h3 className="text-3xl font-black text-gray-800 mb-6 tracking-tight flex-shrink-0">Edit Admin User</h3>
